...
<div class="accordion-item">
    ...
    <div id="collapse{{$id}}" class="accordion-collapse collapse @isset($show) show @endisset" aria-labelledby="heading-{{$id}}" data-bs-parent="#accordionExample">
                    ...
                    <ul class="list-item">
                        ...
                        <li>
                            <label for="menu-link-{{$id}}-{{$key}}">
                                <input id="menu-link-{{$id}}-{{$key}}" class="" type="checkbox" name="menu_id" value="{{$item['url']}}" data-icon="{{$item['icon']}}" data-url="{{$item['url']}}" data-label="{{$item['label']}}">
                                {{$item['label']}}
                            </label>
                        </li>
                        @endforeach
