...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('ABCDebo\Menu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('ABCDebo\Menu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}
