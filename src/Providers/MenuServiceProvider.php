...
namespace ABCDebo\Menu\Providers;
...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../', 'abcdebo-menu');
        ...
        $this->publishes([
            __DIR__ . '/../../resources/views' => resource_path('views/vendor/abcdebo-menu'),
        ], 'laravel-menu-view');

        $this->publishes([
            __DIR__ . '/../../public' => public_path('vendor/abcdebo-menu'),
        ], 'laravel-menu-public');
    ...
    {
        $this->app->bind('abcdebo-menu', function () {
            return new ABCDeboMenu();
        });

        $this->app->make('ABCDebo\Menu\Http\Controllers\MenuController');
