...
class ABCDeboMenu
{
    public function render()
    {
        ...
        if (
            ...
            return view('abcdebo-menu::menu-html')->with("menulist", $menulist);
        } else {
            ...
            return view('abcdebo-menu::menu-html', $data);
        }
    }

    public function scripts()
    {
        return view('abcdebo-menu::scripts');
    }
